...
export function RegistrationPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            // Sign up and pass profile data as metadata
            // The handle_new_user trigger picks this up and inserts into profiles automatically
            ...
            // Success — trigger handles profile creation, go to dashboard
            navigate('/dashboard');
        } catch (err) {
                ...
                <div className="w-full max-w-md">
                    ...
                    <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-5">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input
                                        ...
                                        onBlur={handleBlur}
                                        disabled={isLoading}
                                        className={`w-full px-3.5 py-2.5 border rounded-lg text-sm focus:outline-none focus:ring-2 transition-all disabled:opacity-60 ${
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        onBlur={handleBlur}
                                        disabled={isLoading}
                                        className={`w-full px-3.5 py-2.5 pr-10 border rounded-lg text-sm focus:outline-none focus:ring-2 transition-all disabled:opacity-60 ${
                            ...
                            <button
                                type="submit"
                                disabled={!formData.acknowledgement || isLoading}
                                className="w-full bg-[#1e3a5f] hover:bg-[#152d4a] text-white py-3 rounded-lg font-medium text-sm transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                            >
                                {isLoading ? (
                                    <>
