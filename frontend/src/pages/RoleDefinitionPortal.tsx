...
const initialRoles: Role[] = [
  {
    ...
    bloomLevel: 4,
    description: 'Software developers building secure applications',
    responsibilities: ['Code security', 'Vulnerability assessment', 'Secure coding practices']
  },
  {
    id: '2',
    name: 'Security Lead',
    department: 'Security',
    bloomLevel: 5,
    description: 'Security professionals leading incident response',
    responsibilities: ['Incident management', 'Security strategy', 'Team leadership']
  },
  {
    id: '3',
    name: 'Team Lead',
    ...
    bloomLevel: 5,
    description: 'Team leaders managing cross-functional teams',
    responsibilities: ['Team management', 'Compliance oversight', 'Resource allocation']
  },
  {
    id: '4',
    ...
    bloomLevel: 6,
    description: 'Compliance experts ensuring regulatory adherence',
    responsibilities: ['Policy creation', 'Audit coordination', 'Risk assessment']
  },
];
  ...
  const handleSaveRole = () => {
    if (isAddingRole) {
      const newRole: Role = {
        ...
        bloomLevel: formData.bloomLevel || 1,
      ...
      setRoles(roles.map(role => 
        role.id === editingRoleId ? { ...role, ...formData } as Role : role
      ));
                    ...
                    {bloomLevel && (
                      <div className={`inline-flex items-center gap-2 px-3 py-1.5 rounded-lg border ${bloomLevel.color}`}>
                        ...
                        <span className="text-xs font-semibold">
                          Level {bloomLevel.id}: {bloomLevel.name}
                        </span>
                      </div>
                    )}
                  </div>
